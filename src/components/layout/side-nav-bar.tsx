...
export function SideNavBar() {
  ...
  return (
    <aside className="h-screen w-64 fixed left-0 top-0 border-r border-outline-variant bg-surface-container-lowest flex flex-col py-6 z-50">
      ...
      {/* Navigation */}
      {/* prefetch={false}: con prefetch por defecto, Next dispara 9 requests
          RSC al cargar el dashboard (una por cada item del sidebar) — cada
          uno pasa por middleware + lookup profile en BD. Costaba ~600 ms del
          load inicial. Con prefetch=false los links solo se prefetchean en
          hover, manteniendo navegación rápida sin saturar el primer paint. */}
