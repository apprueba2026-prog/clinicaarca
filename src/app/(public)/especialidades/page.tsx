...
export const metadata: Metadata = {
  ...
  description:
    "Conoce nuestras especialidades: Odontopediatría, Periodoncia e Implantes, y Odontología General. Excelencia clínica en cada tratamiento.",
};
...
export default function EspecialidadesPage() {
  return (
    <>
          ...
          <div className="w-full md:w-1/2 py-16 lg:py-24 px-8 md:px-20">
            <div className="flex flex-col gap-6 md:pl-12">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                ...
                vanguardia. Carga, mediata e inmediata con materiales biocompatibles
                para resultados que duran toda la vida.
              </p>
      ...
      {/* ========== SECCIÓN 3: ODONTOLOGÍA GENERAL ========== */}
      <section id="odontologia-general" className="scroll-mt-24 bg-surface-container-highest/30 overflow-hidden">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center">
          {/* Texto */}
          <div className="w-full md:w-1/2 py-16 lg:py-24 px-8 md:px-20">
