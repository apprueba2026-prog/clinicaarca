...
export default function UbicacionPage() {
  return (
    <main className="pt-12 pb-24 px-6 max-w-7xl mx-auto">
      ...
      {/* ========== GRID PRINCIPAL ========== */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-x-12 lg:gap-y-6 items-start">
        {/* Card: Ubicación */}
        <div className="lg:col-span-5 lg:col-start-1 order-1 bg-surface-container-lowest p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,29,49,0.04)] transition-all hover:-translate-y-1">
        ...
        {/* Mapa */}
        <div className="lg:col-span-7 lg:col-start-6 lg:row-span-3 order-2 lg:order-none h-[400px] lg:h-full min-h-[400px] lg:min-h-[500px] relative group w-full">
        ...
        {/* Card: Contacto */}
        <div className="lg:col-span-5 lg:col-start-1 order-3 lg:order-none bg-surface-container-lowest p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,29,49,0.04)] transition-all hover:-translate-y-1">
          <div className="flex items-start gap-5">
        ...
        {/* Card: Horarios */}
        <div className="lg:col-span-5 lg:col-start-1 order-4 lg:order-none bg-surface-container-lowest p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,29,49,0.04)] transition-all hover:-translate-y-1">
          <div className="flex items-start gap-5">
